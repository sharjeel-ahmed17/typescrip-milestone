...
// todo : answer:
var favNumber = 17;
var messageNum = "my favorite number is " + favNumber;
...
// todo : answer
var greet = names.map(function (item) {
    return "hello ".concat(item, " how are you");
});
console.log(greet);
...
// todo : ansawer:
var favoriteCars = ["land curuzer", "bmw", "farari", "honda"];
var printMes = favoriteCars.map(function (item) {
    return "i would like to own a ".concat(item, " motorcycle");
});
...
// todo : answer :
var guestList = ["usman", "ali", "ahmed"];
var myName = "sharjeel Ahmed";
console.log(guestList);
var printGuestList = guestList.map(function (item) {
    return "Dear ".concat(item, " \n  You are cordially invited to dinner at my place. It would be an honor to have you join us.\n  Best regards,\n  ").concat(myName, "\"");
});
...
// in your list.
// todo : answer :
var unAbleToAtend = "ali";
var replacementGuest = "moin";
var indexOfUnableToAttend = guestList.indexOf(unAbleToAtend);
// console.log(indexOfUnableToAttend);
guestList[indexOfUnableToAttend] = replacementGuest;
console.log("updated guest lists");
console.log(guestList);
var invitedGuest = guestList.map(function (item) {
    return "Dear ".concat(item, " \n  You are cordially invited to dinner at my place. It would be an honor to have you join us.\n  Best regards,\n  ").concat(myName, "\"");
});
...
//  todo : answer :
var addNewGuest = guestList.unshift("ballo bhai");
var addNewGuestInmiddle = Math.floor(guestList.length / 2);
var prinvalues = guestList.splice(addNewGuestInmiddle, 0, "hamza");
guestList.push("daim");
console.log(addNewGuest);
var inviteDinnerOnbigTable = guestList.map(function (item) {
    return "Dear ".concat(item, " \n  You are cordially invited to dinner at my place. It would be an honor to have you join us.\n  Best regards,\n  ").concat(myName, "\"");
});
...
// of your program.
var guestList1 = ["Albert Einstein", "Jane Austen", "Leonardo da Vinci"];
var unableToAttend1 = "Jane Austen";
var replacementGuest1 = "Nikola Tesla";
// Find the index of the guest who can't attend
var indexOfUnableToAttend1 = guestList1.indexOf(unableToAttend1);
...
function inviteToDinner(guestsArray) {
...
var placesToVisit = ["Tokyo", "Paris", "New York", "Sydney", "Cairo"];
// • Print your array in its original order.
console.log("Original order:", placesToVisit);
// • Print your array in alphabetical order without modifying the actual list.
var placesInAlphabeticalOrder = __spreadArray([], placesToVisit, true).sort();
...
var placesInReverseAlphabeticalOrder = __spreadArray([], placesToVisit, true).sort().reverse();
...
console.log("Is testString == 'world'? I predict False.", testString == "world");
console.log("Is testString != 'world'? I predict True.", testString != "world");
console.log("Is testString.length > 5? I predict False.", testString.length > 5);
console.log("Is testString.length <= 5? I predict True.", testString.length <= 5);
var testNumber = 10;
...
console.log("Is upperString.toLowerCase() == 'hello'? I predict True.", upperString.toLowerCase() == "hello");
console.log("Is upperString.toLowerCase() == 'HELLO'? I predict False.", upperString.toLowerCase() == "HELLO");
...
console.log("Is 'apple' in ['apple', 'banana', 'cherry']? I predict True.", ["apple", "banana", "cherry"].includes("apple"));
console.log("Is 'grape' in ['apple', 'banana', 'cherry']? I predict False.", ["apple", "banana", "cherry"].includes("grape"));
// • Test whether an item is not in an array
console.log("Is 'grape' not in ['apple', 'banana', 'cherry']? I predict True.", !["apple", "banana", "cherry"].includes("grape"));
console.log("Is 'apple' not in ['apple', 'banana', 'cherry']? I predict False.", !["apple", "banana", "cherry"].includes("apple"));
...
var usernames12 = ["admin", "eric", "jane", "john", "alice"];
for (var _i = 0, usernames12_1 = usernames12; _i < usernames12_1.length; _i++) {
    var username12 = usernames12_1[_i];
    if (username12 == "admin") {
        console.log("Hello admin, would you like to see a status report?");
    }
    else {
        console.log("Hello ".concat(username12, ", thank you for logging in again."));
    }
}
...
var current_users = ["john", "jane", "doe", "eric", "admin"];
// • Make another list of five usernames called new_users. Make sure one or two of the new usernames are also in the current_users list.
var new_users = ["John", "jane", "susan", "mike", "admin"];
...
function make_shirt12(size, message) {
...
var greatMagicians = __spreadArray([], magiciansCopy, true);
...
var myCar = make_car("Toyota", "Corolla", ["color", "blue"], ["sunroof", true]);
